...
func Test_InitPackageASTCache(t *testing.T) {
	...
	t.Run("ko", func(t *testing.T) {
		...
		InitPackageASTCache("./internal/testdata/ko")
	})
}
...
func Test_GetPackageAST(t *testing.T) {
	t.Run("ok", func(t *testing.T) {
		pkgDir := "./internal/testdata/ok"
		pkgPath := "github.com/krostar/test/internal/code/internal/testdata/ok"
	...
	t.Run("ko", func(t *testing.T) {
		pkgs, err := GetPackageAST("./internal/testdata/ko")
		if err == nil || pkgs != nil {
